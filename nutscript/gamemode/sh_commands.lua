...
nut.command.Register({
	...
	onRun = function(client, arguments)
		...
		if (target) then
			...
			nut.util.Notify(client:Name().." has given "..nut.currency.GetName(amount).." to "..target:Name()..".", client)
		end
	end
}, "chargivemoney")
...
nut.command.Register({
	...
	onRun = function(client, arguments)
		...
		if (target) then
			...
			target:GiveMoney(-amount)
			nut.util.Notify(client:Name().." has taken "..nut.currency.GetName(amount).." from "..target:Name()..".", client)
		end
	end
}, "chartakemoney")
...
nut.command.Register({
	...
	onRun = function(client, arguments)
		...
		if (target) then
			...
			nut.util.Notify(client:Name().." has set "..target:Name().."'s money to "..amount..".", client)
		end
	end
}, "charsetmoney")
